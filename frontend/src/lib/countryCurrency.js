// Mirrors backend/src/data/countryCurrency.js — exact table from the
// client's country/currency PDF.
...
export const COUNTRIES = Object.keys(CURRENCY_BY_COUNTRY);
export const CURRENCIES = [...new Set(Object.values(CURRENCY_BY_COUNTRY))].sort();