// Field schema — every group/field lifted from the wireframe PDF, tagged by
// who conventionally supplies the value. Stage *ownership* (which portal can
// touch the stage at all) is enforced separately in lib/permissions.js.
...
export const INTIMATION_SCHEMA = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "pincode", label: "Pincode", type: "text", source: "customer", req: "*" },
      { id: "regionOfLoss", label: "Region of Loss", type: "text", source: "customer", req: "*" },
    ],
  },
  {
    title: "Claim Details",
    fields: [
      ...
      { id: "fileBurglary", label: "Do you want to file Burglary Cover?", type: "select", source: "customer", options: ["Yes", "No"] },
    ],
  },
  {
  ...
  },
  {
    title: "Communication",
    fields: [
      { id: "commEmail", label: "Comm. Email", type: "text", source: "customer", req: "*" },
      { id: "commContact", label: "Comm. Contact", type: "text", source: "customer", req: "*" },
      { id: "otherCommEmail", label: "Other Comm. Email", type: "text", source: "customer" },
      { id: "otherCommContact", label: "Other Comm. Contact", type: "text", source: "customer" },
    ],
  },
  {
    title: "Airline / Carrier",
    fields: [
      { id: "airlineName", label: "Airline/Carrier Name", type: "text", source: "customer" },
      { id: "flightNumber", label: "Flight/Carrier Number", type: "text", source: "customer" },
    ],
  },
  {
    title: "Investigator (if applicable)",
    fields: [
...
export const ASSESSMENT_CORE = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "assessNonMedical", label: "Assessment required for Non-Medical Covers?", type: "select", source: "insurer", options: ["Yes", "No"] },
...
export const ASSESSMENT_MEDICAL = [
  {
    ...
    fields: [
      { id: "medCoverName", label: "Cover Name", type: "text", source: "insurer", req: "*" },
...
export const ASSESSMENT_NONMED = [
  {
    title: "Non-Medical Claim Assessment",
    fields: [
      { id: "nonMedCoverName", label: "Cover Name", type: "select", source: "insurer", req: "*", options: ["Trip Cancellation & Interruption", "Trip Delay", "Missed Flight Connection", "Total Loss of Checked-in Baggage", "Delay of Checked-in Baggage", "Loss of Passport / ID", "Personal Liability", "Financial Assistance", "Emergency Hotel Accommodation", "Fire Cover for Building", "Fire Cover for Contents", "Burglary Cover for Home Contents"] },
      ...
      { id: "currencyAssessNM", label: "Currency as per Assessment", type: "select", source: "insurer", options: ["INR", "USD"] },
    ],
  },
];
